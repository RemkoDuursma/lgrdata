...
<!-- badges: start -->
[![R-CMD-check](https://github.com/RemkoDuursma/lgrdata/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/RemkoDuursma/lgrdata/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
